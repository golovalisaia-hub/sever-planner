...
test('Asset versions are aligned to v27', () => { for (const asset of ['style.css', 'qa.css', 'responsive.css', 'app.js', 'notes-pro.js']) { assert.match(html, new RegExp(`${asset.replace('.', '\\.')}\\?v=27`)); assert.match(sw, new RegExp(`${asset.replace('.', '\\.')}\\?v=27`)); } assert.match(sw, /sever-v27/); });
