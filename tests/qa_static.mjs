...
test('Asset versions are aligned to v31', () => { for (const asset of ['style.css', 'qa.css', 'responsive.css', 'design-system.css', 'app.js', 'notes-pro.js']) { assert.match(html, new RegExp(`${asset.replace('.', '\\.')}\\?v=31`)); assert.match(sw, new RegExp(`${asset.replace('.', '\\.')}\\?v=31`)); } assert.match(sw, /sever-v31/); });
