...
test('installed PWA ships v103 autumn polish while preserving v102 desktop and v101 reliability', () => {
  ...
  assert.ok(sw.includes("'./sever2-interaction-polish.js?v=101'"));
