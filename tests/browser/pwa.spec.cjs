...
test('installed release reloads offline with one complete asset set', async ({ browser }) => {
  ...
  try {
    ...
    for (const asset of [
      ...
      '/sever2-notes-navigation.css?v=74','/sever2-notes-navigation.js?v=74','/sever2-notes-polish.css?v=75','/sever2-notes-polish.js?v=75','/js/theme-init.js?v=75','/app.js?v=51','/notes-pro.js?v=52','/js/sync-core.mjs?v=55','/js/cloud-runtime.js?v=55'
