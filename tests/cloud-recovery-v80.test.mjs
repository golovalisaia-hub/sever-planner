...
test('cloud recovery v80 remains in the current atomic PWA release', () => {
  ...
  assert.ok(release && Number(release[1]) >= 102, 'current atomic cache must preserve v102+ cloud recovery assets');
  for (const asset of [
