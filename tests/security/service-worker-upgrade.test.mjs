...
const RELEASE_CACHE = 'sever-v66-home-core-v1';

test('v66 service worker installs the Home core release atomically and removes stale caches', async () => {
  ...
  assert.ok(cachedAssets.includes('./js/theme-init.js?v=70'));
