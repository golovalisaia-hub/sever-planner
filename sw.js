const CACHE = 'sever-v42-sync-calendar-r1';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=42',
  './qa.css?v=42',
  './responsive.css?v=42',
  './design-system.css?v=42',
  './mobile-system.css?v=42',
  './onboarding.css?v=42',
  './northern.css?v=42',
  './northern-components.css?v=42',
  './sever-v41.css?v=42',
  './reference-theme.css?v=42',
  './aurora.webp',
  ...
  './js/theme-init.js?v=42',
  './js/protected-notes-crypto.js?v=42',
  './js/security-core.js?v=42',
  './js/supabase-client.js?v=42',
  './js/ui-state.js?v=42',
  './js/sync-core.mjs?v=42',
  './js/cloud-runtime.js?v=42',
