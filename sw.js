const CACHE='sever-v23';
const ASSETS=['./','./index.html','./style.css?v=23','./qa.css?v=23','./app.js?v=23','./notes-pro.js?v=23','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
