const CACHE='sever-v21';
const ASSETS=['./','./index.html','./style.css?v=21','./qa.css?v=21','./app.js?v=21','./notes-pro.js?v=21','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
