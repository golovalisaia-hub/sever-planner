const CACHE='sever-v22';
const ASSETS=['./','./index.html','./style.css?v=22','./qa.css?v=22','./app.js?v=22','./notes-pro.js?v=22','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
